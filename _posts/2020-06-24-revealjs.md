...
comments: true
---
<div class="center" style="background-color:#1a1626; border-radius:30px; margin-bottom:10px;padding-top: 8px;"><a href="https://revealjs.com" style="width: 100%;height: 100%;display: inline-block;"><img src="{{ '/assets/img/reveallogo.svg' | prepend: site.baseurl | prepend: site.url }}" alt="The reveal.js logo" class="postimage one"></a></div>
